...
SRC	= main.cpp machine.cpp object.cpp module.cpp parser.cpp math_commands.cpp variables_commands.cpp stack_commands.cpp control_commands.cpp utilities.cpp list_commands.cpp logical_commands.cpp functional_commands.cpp io_commands.cpp string_commands.cpp type_commands.cpp execution_commands.cpp environment_commands.cpp
